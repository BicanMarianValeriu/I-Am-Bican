...
const Meta = (props) => {
    ...
    money = money.map((val, i) => (
        <ReactSVG className="portfolio__cost-svg" key={i} src={icons.banknote} svgClassName="svg-icon svg-icon--cost" />
    ));
    ...
    return (
        <div className="portfolio__meta">
            <span className="portfolio__meta-item" title="Live url">
                <ReactSVG className="portfolio__meta-label" src={icons.website} svgClassName="svg-icon svg-icon--portfolio-meta" />
                <span className="portfolio__website" dangerouslySetInnerHTML={{__html: website}}></span>
            </span>
            <span className="portfolio__meta-item" title="Cost range">
            <ReactSVG className="portfolio__meta-label" src={icons.money} svgClassName="svg-icon svg-icon--portfolio-meta" />
                <span className="portfolio__cost">{count > 0 ? money : 'Free'}</span>
            </span>
            <span className="portfolio__meta-item" title="Went live on:">
                <ReactSVG className="portfolio__meta-label" src={icons.clock} svgClassName="svg-icon svg-icon--portfolio-meta" />
                <time className="portfolio__date" dateTime={date_gmt}>{date_human}</time>
            </span>
        </div>
    );
}
