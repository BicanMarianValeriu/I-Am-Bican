...
// Components
import AboutContent from './sections/home/about-me-info';
...
export default class AboutMe extends Component {
    ...
    _onMouseOver() {
        ...
        import(/* webpackChunkName: "swalcontact" */ './popups/swal-contact').then((modal) => this.setState({
            Modal: modal.default
        }));
    }
    ...
    animateProfilePicture() {
        ...
        image.addEventListener('mousemove', (e) => {
            ...
            let xPos = (mouseX / image.offsetWidth) * 100 - 100, yPos = (mouseY / image.offsetHeight) * 100 - 100;
                        ...
                        <div className="row justify-content-end">
                            <div className="col-4 col-lg-3 text-center">
                                <a href="#footer" className="about-me__link">
                                    <ReactSVG src={Icon1} svgClassName="svg-icon svg-icon--about-section" className="about-me__link-icon" />
                                    <span>Contact Information</span>
                                </a>
                            </div>
                            <div className="col-4 col-lg-2 text-center">
                                <a href="#sendmsg" className="about-me__link"
                                    onClick={this._onButtonClick}
                                    onMouseOver={this._onMouseOver}
                                    onTouchStart={this._onMouseOver}>
                                    <ReactSVG src={Icon2} svgClassName="svg-icon svg-icon--about-section" className="about-me__link-icon" />
                                    <span>Send Message</span>
                                </a>
                            </div>
                            <div className="col-4 col-lg-3 text-center">
                                <Link to="/portfolio" className="about-me__link">
                                    <ReactSVG src={Icon3} svgClassName="svg-icon svg-icon--about-section" className="about-me__link-icon" />
