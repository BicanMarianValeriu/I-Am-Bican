...
const Empy = (props) => (
	<div className="entry entry--empty">
		...
		>
			...
			<rect x="123" y="343" rx="3" ry="3" width="906" height="17" />
			...
			<circle cx="743" cy="250" r="20" />
			<rect x="739" y="230" rx="0" ry="0" width="67" height="40" />
			<circle cx="802" cy="250" r="20" />

			<circle cx="890" cy="250" r="20" />
			<rect x="890" y="230" rx="0" ry="0" width="140" height="40" />
			<circle cx="1032" cy="250" r="20" />
		</ContentLoader>
	</div>
)
