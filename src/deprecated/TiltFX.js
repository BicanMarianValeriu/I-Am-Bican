import { lerp, lineEq, getMousePos } from '../utilities/helpers';

export default class TiltFx {
    constructor(el, options) {
        this.winsize = window.wecodeart.winsize;
        this.DOM = { el: el };
        this.options = {
            valuesFromTo: [-50, 50],
    ...
    start() {
        if (!this.requestId) this.requestId = window.requestAnimationFrame(() => this.render());
    }
